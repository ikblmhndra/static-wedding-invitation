      ...
      <div className="section-inner relative py-12 sm:py-20 lg:py-24">
        <div className="grid gap-8 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-6 text-5xl leading-[0.92] text-truffle sm:text-7xl lg:text-[5.6rem]">
              {names}
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-[#6f5f59] sm:text-xl">
              {hero.quote}
            </p>
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              <div className="secondary-card flex items-center gap-4 px-5 py-5">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-gold/15 bg-gold/8 text-gold">
          ...
          <div className="grid gap-4 sm:grid-cols-[0.72fr_0.28fr] lg:justify-self-end lg:max-w-[34rem]">
            <div className="editorial-shell p-4 sm:p-5">
              <div className="photo-frame aspect-[4/5] rounded-[2rem]">
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 text-white">
                  <p className="eyebrow-note text-white/[0.65]">Save The Date</p>

...
export function WishesList() {
  ...
  return (
    <div className="border-t border-[#ead8cd] pt-6">
      <p className="font-medium text-truffle">RSVPs from our guests</p>
              ...
              >
                <div className="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className="rounded-full bg-[#f3ece8] px-2.5 py-0.5 text-[0.65rem] font-medium uppercase tracking-[0.08em] text-[#8a6f63]">
                      {wish.guest_count} {wish.guest_count === 1 ? "guest" : "guests"}
                    </span>
                  </div>
                ...
                {message ? <p className="mt-2 whitespace-pre-wrap">{message}</p> : null}
              </li>
            );
          })}
        </ul>
